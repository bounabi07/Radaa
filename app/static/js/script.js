const translations = {
    en: {
        ...
        home: "Home", about: "About", login: "Login", register: "Register", email: "Email :", password: "Password :", username: "Username :", login_btn: "Login to Terminal", create_account: "Create Account", or: "or", continue_with_google: "Continue with Google", email_placeholder: "name@example.com", password_placeholder: "••••••••", username_placeholder: "Enter username", new_here: "New here?", already_have_account: "Already have an account?", about_radaa: "About Radaa",
        email_already_used: "Email already in use", account_created_verify_email: "Account created successfully! Please check your email to activate it before logging in.", activation_email_failed: "Account created, but activation email failed to send. Please try again later.", email_not_found: "Email not found", incorrect_password: "Incorrect password", account_not_verified: "Your account is not verified yet! Please check your email and click the activation link.", activation_link_invalid_or_expired: "Activation link is invalid or has expired.", account_already_verified: "Account already verified! You can log in.", account_verified_success: "Your account has been verified successfully! You can now log in.", user_not_found: "User not found.",
        reset_link_sent: "A reset link has been sent to your email.", reset_link_failed: "Failed to send email. Try again later.", reset_link_if_exists_sent: "If the email exists, a reset link has been sent.", reset_link_invalid_or_expired: "The reset link is invalid or has expired.", confirm_password_mismatch: "Confirm password doesn't match!",
    ...
    ar: {
        ...
        home: "الرئيسية", about: "من نحن", register: "تسجيل", email: "البريد الإلكتروني :", password: "كلمة المرور :", username: "اسم المستخدم :", login_btn: "تسجيل الدخول إلى الردع", create_account: "إنشاء حساب", or: "أو", continue_with_google: "استمر مع Google", email_placeholder: "name@example.com", password_placeholder: "••••••••", username_placeholder: "أدخل اسم المستخدم", new_here: "جديد هنا؟", already_have_account: "هل لديك حساب بالفعل؟", about_radaa: "عن ردع",
        email_already_used: "البريد الإلكتروني مستخدم مسبقاً", account_created_verify_email: "تم إنشاء الحساب بنجاح! يرجى التحقق من بريدك الإلكتروني لتفعيله قبل تسجيل الدخول.", activation_email_failed: "تم إنشاء الحساب، ولكن فشل إرسال بريد التفعيل. يرجى المحاولة لاحقاً.", email_not_found: "البريد الإلكتروني غير موجود", incorrect_password: "كلمة المرور غير صحيحة", account_not_verified: "حسابك غير مفعّل بعد! يرجى مراجعة بريدك الإلكتروني وضغط رابط التفعيل.", activation_link_invalid_or_expired: "رابط التفعيل غير صالح أو انتهت صلاحيته.", account_already_verified: "الحساب مفعّل بالفعل! يمكنك تسجيل الدخول.", account_verified_success: "تم تفعيل حسابك بنجاح! يمكنك الآن تسجيل الدخول.", user_not_found: "المستخدم غير موجود.",
        reset_link_sent: "تم إرسال رابط إعادة التعيين إلى بريدك الإلكتروني.", reset_link_failed: "فشل إرسال البريد الإلكتروني. حاول مرة أخرى لاحقاً.", reset_link_if_exists_sent: "إذا كان البريد موجوداً، فقد تم إرسال رابط إعادة التعيين.", reset_link_invalid_or_expired: "رابط إعادة التعيين غير صالح أو انتهت صلاحيته.", confirm_password_mismatch: "تأكيد كلمة المرور غير متطابق!",
    ...
    fr: {
        ...
        home: "Accueil", about: "À propos", login: "Connexion", register: "Inscription", email: "Email :", password: "Mot de passe :", username: "Nom d'utilisateur :", login_btn: "Se connecter", create_account: "Créer un compte", or: "ou", continue_with_google: "Continuer avec Google", email_placeholder: "name@example.com", password_placeholder: "••••••••", username_placeholder: "Entrez le nom d'utilisateur", new_here: "Nouveau ici ?", already_have_account: "Vous avez déjà un compte ?", about_radaa: "À propos de Radaa",
        email_already_used: "Email déjà utilisé", account_created_verify_email: "Compte créé avec succès ! Veuillez vérifier votre e-mail pour l'activer avant de vous connecter.", activation_email_failed: "Compte créé, mais l'e-mail d'activation n'a pas pu être envoyé. Veuillez réessayer plus tard.", email_not_found: "E-mail introuvable", incorrect_password: "Mot de passe incorrect", account_not_verified: "Votre compte n'est pas encore vérifié ! Veuillez vérifier votre e-mail et cliquer sur le lien d'activation.", activation_link_invalid_or_expired: "Le lien d'activation est invalide ou a expiré.", account_already_verified: "Compte déjà vérifié ! Vous pouvez vous connecter.", account_verified_success: "Votre compte a été vérifié avec succès ! Vous pouvez maintenant vous connecter.", user_not_found: "Utilisateur non trouvé.",
        reset_link_sent: "Un lien de réinitialisation a été envoyé à votre adresse e-mail.", reset_link_failed: "Échec de l'envoi de l'e-mail. Réessayez plus tard.", reset_link_if_exists_sent: "Si l'e-mail existe, un lien de réinitialisation a été envoyé.", reset_link_invalid_or_expired: "Le lien de réinitialisation est invalide ou a expiré.", confirm_password_mismatch: "La confirmation du mot de passe ne correspond pas !",
    ...
    ary: {
        ...
        home: "الرئيسية", about: "شكون احنا", login: "تسجيل الدخول", register: "تسجيل", email: "البريد الإلكتروني :", password: "كلمة المرور :", username: "اسم المستخدم :", login_btn: "تسجيل الدخول إلى الردع", create_account: "إنشاء حساب", or: "ولا", continue_with_google: "كمل مع Google", email_placeholder: "name@example.com", password_placeholder: "••••••••", username_placeholder: "دخل اسم المستخدم", new_here: "جديد هنا؟", already_have_account: "عندك حساب؟", about_radaa: "على ردع",
        email_already_used: "البريد الإلكتروني مستعمل من قبل", account_created_verify_email: "تم إنشاء الحساب بنجاح! راجع بريدك باش تفعل الحساب قبل ما تدخل.", activation_email_failed: "تم إنشاء الحساب، لكن إرسال البريد ديال التفعيل طاح. حاول من بعد.", email_not_found: "الإيميل ما لقيتوش", incorrect_password: "كلمة السر خطأ", account_not_verified: "الحساب مازال ما تفعّلش! راجع الإيميل و ضغَط على رابط التفعيل.", activation_link_invalid_or_expired: "رابط التفعيل غير صالح أو سالات صلاحيته.", account_already_verified: "الحساب مفعّل أصلاً! تقدر تدخل دابا.", account_verified_success: "الحساب تفعل بنجاح! تقدر تدخل دابا.", user_not_found: "المستخدم ما لقيتوش.",
        reset_link_sent: "تبعت ليك رسالة رابط إعادة التعيين للإيميل ديالك.", reset_link_failed: "ما قدرناش نرسل الإيميل. جرب من بعد.", reset_link_if_exists_sent: "إلا كان الإيميل كاين، تبعت ليك رسالة رابط إعادة التعيين.", reset_link_invalid_or_expired: "رابط إعادة التعيين غير صالح أو سالات صلاحيته.", confirm_password_mismatch: "تأكيد كلمة السر ما متطابقش!",
